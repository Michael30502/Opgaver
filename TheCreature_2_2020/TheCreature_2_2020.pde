...
//int værdier er blevet ændret til float da der regnes med kommatal
...
void draw() {    
  //Følgende linje er blevet tiløfet da den var sat some en kommentar
  float ballWalk =  sin(ballX*0.5)*10;  //svingning på +10 til -10 pixels 
  ballX         =  ballX  +  speedX;    //flytter min bold 
  ballY         =  ballY  +  speedY+ballWalk; //ballWalk er blevet pluset til ballY da det vil skabet variation i hvordan cirklen bevæger sig
